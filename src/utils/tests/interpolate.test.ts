...
describe('interpolate', () => {
  ...
  describe('Edge cases and malformed input', () => {
    ...
    it('should handle nested braces', () => {
      expect(
        interpolate('Data: %{user.field}', { 'user.field': 'value' })
      ).toBe('Data: value');
    });
    ...
    it('should handle regex special characters in keys', () => {
      expect(interpolate('Match: %{pattern}', { pattern: 'matched' })).toBe(
        'Match: matched'
      );
    });
  });
  ...
  describe('Custom value formatter with defaultFormatter access', () => {
    ...
    it('should handle custom formatter with complex logic', () => {
      ...
      expect(result).toBe(
        'Report: "Sales Report" - Generated on 2023-12-25 by Admin'
      );
    });
  });
  ...
  describe('Error handling and robustness', () => {
    ...
    it('should handle deeply nested object access', () => {
      ...
      expect(
        interpolate('Value: %{a.b.c.d}', { 'a.b.c.d': 'deep value' })
      ).toBe('Value: deep value');
    });

    it('should handle prototype pollution attempts', () => {
      const params = { constructor: 'polluted' };
      expect(interpolate('Test: %{constructor}', params)).toBe(
        'Test: polluted'
      );
    });
  });
  ...
  describe('Special number object types', () => {
    ...
    it('should handle String object wrapper', () => {
      ...
      expect(interpolate('Value: %{val}', { val: strObj })).toBe(
        'Value: hello'
      );
    });
    ...
    it('should handle Boolean object wrapper', () => {
      ...
      expect(interpolate('Value: %{val}', { val: boolObj })).toBe(
        'Value: true'
      );
    });
  });
